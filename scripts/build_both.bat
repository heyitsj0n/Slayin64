...
set SLAYIN_VARIANT=
%U% -batchmode -nographics -projectPath %P% -executeMethod SlayinBuild.Android -quit -logFile %P%\unity_build.log
echo BUILD1 exit %errorlevel%
